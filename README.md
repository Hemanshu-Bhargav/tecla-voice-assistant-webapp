...
This project used messaging queue tools to exchange data between a desktop computer or mobile phone and a raspberry pi. That functionality is not present in this repository.
